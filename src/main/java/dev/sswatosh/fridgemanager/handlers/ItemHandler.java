    ...
    public void handle(Context ctx) throws Exception {
        ...
        ctx.byMethod(method -> method
            .get(() -> ctx.insert(
                ...
                context -> context.render(json(itemController.getItem(getItemId(ctx), fridgeId)))
            ))
            .patch(() -> ctx.insert(
                AuthUtil.requirePermissions(Permissions.VIEW_ITEMS, Permissions.ADD_EDIT_ITEMS),
            ...
            .delete(() -> ctx.insert(
                AuthUtil.requirePermissions(Permissions.DELETE_ITEMS),
                context -> {
